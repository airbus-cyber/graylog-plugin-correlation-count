...
module.exports = new PluginWebpackConfig(__dirname,'com.airbus_cyber_security.graylog.CorrelationCountPlugin', loadBuildConfig(path.resolve(__dirname, './build.config')), {
